const navbarComponent = () => {
    return `<div class="container">
        <div class="navlogo-for-small d-block d-lg-none"><img role="button" src="../images/navbar-images/shrine-black.svg" alt="Shrine Black"></div>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mb-2 mb-lg-0 w-100 d-lg-flex justify-content-lg-between align-items-lg-center">
                ...
                <div class="navlogo-for-large d-none d-lg-flex  bg-white align-items-lg-center position-absolute px-2 px-xl-5">
                    <img role="button" src="../images/navbar-images/shrine-black.svg" alt="Shrine Black">
                </div>
                <div class="d-lg-flex gap-3 gap-xl-4 align-items-lg-center">
                    <li class="nav-item position-relative">
                    ...
                    <div class="search-icon">
                        <a href="#"><img src="../images/navbar-images/search.svg" alt="search"></a>
                    </div>
                    <div class="bag-icon position-relative">
                        <a href="#"><img class="mt-3 mt-lg-auto" src="../images/navbar-images/bag.svg" alt="Bag"></a>
                        <span
