const footerComponent = () => {
    return ` <div class="container pt-5">
        <div class="footer-logo-text row justify-content-between align-items-center ">
            <img class="col-5 col-md-4 col-lg-3" src="../images/footer-images/shrine-white.svg" alt="Shrine Logo">
        ...
        <div
            ...
            <div class="d-flex justify-content-center gap-3">
                <img role="button" src="../images/footer-images/instagram.svg" alt="Instagram">
                <img role="button" src="../images/footer-images/twitter.svg" alt="Twitter">
                <img role="button" src="../images/footer-images/whatsapp.svg" alt="Whatsapp">
                <img role="button" src="../images/footer-images/youtube.svg" alt="Youtube">
                <img role="button" src="../images/footer-images/facebook.svg" alt="Facebook">
            </div>
        </div>
    </div>`
}
